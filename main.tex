...
Nach Abschluss der Bereinigung wird der Button \glqq Dubletten finden\grqq{} freigeschaltet. Dabei prüft ein Fuzzy-Matching mittels TF-IDF-Vektorisierung und Nearest-Neighbor-Suche auf Basis der Attribute \texttt{company}, \texttt{location}, \texttt{jobtype} und \texttt{jobdescription} auf inhaltliche Dubletten. Gefundene Duplikate werden aus dem Dataframe entfernt und in einem separaten Fenster \glqq Gefundene Dubletten\grqq{} tabellarisch dargestellt.
