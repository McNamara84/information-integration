...
Darüber hinaus sollen inhaltliche Dubletten identifiziert und separat gespeichert, die Orte mittels der SQL-Datei \texttt{ort\_bundesland.sql} um das Attribut \texttt{\_REGION\_} erweitert sowie aus dem Freitextfeld \texttt{\_JOBTERMS\_} Informationen zu Befristung, Arbeitszeit und Vergütung extrahiert werden. Kann ein Ort über das Mapping nicht zugeordnet werden, ermittelt eine Koordinatenanalyse mit dem Offline-Datensatz \texttt{reverse\_geocoder} das Bundesland. Der bereinigte und angereicherte Datensatz wird abschließend in ein PostgreSQL-basiertes DWH überführt und dort unter Anwendung eines Sternschemas statistisch analysiert.
